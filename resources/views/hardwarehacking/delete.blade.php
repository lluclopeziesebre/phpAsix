...
<head>
    ...
    <title>Delete item - Project ASIX</title>
    <style>
        /* Paleta de colors */
        :root {
...
<section class="content">
    ...
    <form action="/hardwarehacking/destroy/<?= $item->id ?>" method="POST">
        <button type="submit">Delete</button>
        <a href="/hardwarehacking">Cancel</a>
    </form>
    <img style="margin: 7%;" src="https://media2.giphy.com/media/v1.Y2lkPTc5MGI3NjExOWNwaHh3MHJhOWF1ZHFnMjV5MGgybDE4ZnI0djllZzM4MXpnMGVtNyZlcD12MV9pbnRlcm5hbF9naWZfYnlfaWQmY3Q9Zw/FO2ALAo2bwU1Vq45bJ/giphy.gif" alt="Excited GIF">
</section>
