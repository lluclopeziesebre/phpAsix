...
<head>
    ...
    <title>Add book - Project ASIX</title>
    <style>
        /* Paleta de colors */
        :root {
...
<section class="content">
    <h3 style="text-align: center; margin-bottom: 2%; font-weight: bold;">Add Book:</h3>
    <div class="tailwind-container">
        <form action="/books/store" method="POST"
              class="max-w-2xl mx-auto bg-white p-6 rounded-lg shadow-lg">
            <div class="mb-4">
                <label for="name"
            ...
            <div class="mb-4">
                <label for="releaseYear"
                       class="block text-sm font-medium text-gray-700">Release Year</label>
                <input type="number" name="releaseYear" id="releaseYear"
                       class="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md"
                       required min="1900" max="<?= date('Y'); ?>" step="1">
            </div>
            <button type="submit"
                    class="bg-blue-500 text-white px-4 py-2 rounded hover:bg-blue-700">Add</button>
        </form>
    </div>
</section>
<footer>
